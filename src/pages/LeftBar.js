  ...
  return (
    <div className="text-[#a2aabc] text-lg mt-5 flex bg-[#262526] h-full">
      <div className="pb-4 h-75 overflow-auto h-5/6">
        ...
        <div className="absolute inset-x-0 bottom-10  right-0">
          <div className="flex px-6 space-x-7">
            <a href="https://github.com/FelipeJhordan">
              <img
                src={GitLogo}
                alt="Git Logo"
            ...
            <a href="https://twitter.com/FelipeJhordan">
              <img
                src={TwitterLogo}
                alt="Kaggle Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
            ...
            <a href="https://www.linkedin.com/in/felipe-jhordan-maciel-alves-5b191917b/">
              <img
                src={LinkedinLogo}
                alt="Linkedin Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
            ...
            <a href="mailto:felipejordan.alves@gmail.com?subject=Assunto">
              <img
                src={MailLogo}
                alt="Mail Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
